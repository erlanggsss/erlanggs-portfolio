...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "852a19a7-e96d-4de5-837f-7a5fa11dc685");
      ...
      className='text-center mb-2 text-lg font-Ovo'>
        ...
        onSubmit={onSubmit} className='max-w-2xl mx-auto'>
          <div className='grid grid-cols-auto gap-6 mt-10 mb-8'>
            ...
            type="email" placeholder='Enter your mail' required className='flex-1 p-3 outline-none border-[0.5px]
          ...
          hover:bg-black duration-500 dark:bg-transparent dark:border-[0.5px] dar:hover:bg-darkHover'>
